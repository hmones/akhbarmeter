...
@section('content')
    ...
    <div class="container mx-auto my-8 px-4" dir="ltr">
        ...
        <ul class="ml-4 my-4">
            ...
            <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to AkhbarMeter, that is responsible for your information under this Cookie Policy.</li>
            ...
            <li>Website:  site, which can be accessed via this URL: https://akhbarmeter.org</li>
        </ul>
        <p>This Cookie Policy was created with <a href="https://termify.io" target="_blank">Termify</a>.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Introduction</h1>
        <p>This Cookie Policy explains how AkhbarMeter and its affiliates (collectively "AkhbarMeter", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website, including without limitation https://akhbarmeter.org and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">What is a cookie?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Why do we use cookies?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">What type of cookies does AkhbarMeter use?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Performance and Functionality Cookies</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Marketing Cookies</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Analytics and Customization Cookies</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">How you can manage cookies?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Changes To Our Cookie Policy</h1>
        ...
        <ul class="ml-4 my-4"><li>Via Email:  <a href="info@akhbarmeter.org">info@akhbarmeter.org</a></li><li>Via this Link:  https://akhbarmeter.org/contact</li>
        </ul>
    </div>
@endsection
