...
@section('content')
    ...
    <div class="container flex flex-col w-full items-center justify-center mx-auto space-y-4 my-16">
        <div class="flex flex-col">
            <h1 class="text-4xl md:text-5xl leading-10 font-extrabold tracking-tight">Privacy Policy</h1>
        </div>
    </div>
    ...
    <div class="container mx-auto my-8 px-4" dir="ltr">
        ...
        <br>
        <p> AkhbarMeter (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by AkhbarMeter.</p>
        <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, AkhbarMeter. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service. This Privacy Policy was created with <a href="https://termify.io" target="_blank">Termify</a>.</p>
        ...
        <ul class="ml-4 my-4">
            ...
            <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to eCitizen, 3, Makram Ebeid, Al Manteqah as Sadesah, Nasr City, Cairo Governorate that is responsible for your information under this Privacy Policy.</li>
            <li>Country: where AkhbarMeter or the owners/founders of AkhbarMeter are based, in this case is Egypt</li>
            <li>Customer: refers to the company, organization or person that signs up to use the AkhbarMeter Service to manage the relationships with your consumers or service users.</li>
            <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit AkhbarMeter and use the services.</li>
            ...
            <li>Personnel: refers to those individuals who are employed by AkhbarMeter or are under contract to perform a service on behalf of one of the parties.</li>
            ...
            <li>Service: refers to the service provided by AkhbarMeter as described in the relative terms (if available) and on this platform.</li>
            ...
            <li>Website: AkhbarMeter's site, which can be accessed via this URL: https://akhbarmeter.org</li>
            <li>You: a person or entity that is registered with AkhbarMeter to use the Services.</li>
        </ul>
        </p>
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">What Information Do We Collect?</h1>
        ...
        <ul class="ml-4 my-4"><li>Email Addresses</li>
        </ul><ul class="ml-4 my-4">
        </ul>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">How Do We Use The Information We Collect?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">When does AkhbarMeter use end user information from third parties?</h1>
        <p>AkhbarMeter will collect End User Data necessary to provide the AkhbarMeter services to our customers.</p>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">When does AkhbarMeter use customer information from third parties?</h1>
        <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a AkhbarMeter customer, we receive information from a third party that provides automated fraud detection services to AkhbarMeter. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Do we share the information we collect with third parties?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Where and when is information collected from customers and end users?</h1>
        <p>AkhbarMeter will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">How Do We Use Your Email Address?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">How Long Do We Keep Your Information?</h1>
        <p>We keep your information only so long as we need it to provide AkhbarMeter to you and fulfill the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply with our legal or regulatory obligations, we’ll either remove it from our systems or depersonalize it so that we can't identify you.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">How Do We Protect Your Information?</h1>
        <p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive/credit information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our Payment gateway providers database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to AkhbarMeter or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Could my information be transferred to other countries?</h1>
        <p>AkhbarMeter is incorporated in Egypt. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Is the information collected through the AkhbarMeter Service secure?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Can I update or correct my information?</h1>
        <p>The rights you have to request updates or corrections to the information AkhbarMeter collects depend on your relationship with AkhbarMeter. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Personnel</h1>
        <p>If you are a AkhbarMeter worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Sale of Business</h1>
        <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of AkhbarMeter or any of its Corporate Affiliates (as defined herein), or that portion of AkhbarMeter or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Affiliates</h1>
        <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with AkhbarMeter, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Governing Law</h1>
        <p>This Privacy Policy is governed by the laws of Egypt without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
        <p>The laws of Egypt, excluding its conflicts of law rules, shall govern this Agreement and your use of the website. Your use of the website may also be subject to other local, state, national, or international laws.</p>
        <p>By using AkhbarMeter or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Your Consent</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Links to Other Websites</h1>
        <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by AkhbarMeter. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Cookies</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Blocking and disabling cookies and similar technologies</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Kids' Privacy</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Changes To Our Privacy Policy</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Third-Party Services</h1>
        ...
        <p>You acknowledge and agree that AkhbarMeter shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. AkhbarMeter does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Tracking Technologies</h1>
        <ul class="ml-4 my-4">
            <li>Google Maps API
                <br><br>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Information about General Data Protection Regulation (GDPR)</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">What is GDPR?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">What is personal data?</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Why is GDPR important?</h1>
        <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that they collect and process. It also raises the stakes for compliance by increasing enforcement and imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At AkhbarMeter we strongly believe that your data privacy is very important and we already have solid security and privacy practices in place that go beyond the requirements of this new regulation.</p>

        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Individual Data Subject's Rights - Data Access, Portability and Deletion</h1>
        <p>We are committed to helping our customers meet the data subject rights requirements of GDPR. AkhbarMeter processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all conversation and personal data for up to 6 years unless your account is deleted. In which case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.</p>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">California Residents</h1>
        ...
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">California Online Privacy Protection Act (CalOPPA)</h1>
        ...
        <p>We do not sell the Personal Information of our users.</p>
        <p>For more information about these rights, please contact us.</p>
        <h1 class="text-3xl leading-10 font-extrabold tracking-tight my-4">Contact Us</h1>
        <p>Don't hesitate to contact us if you have any questions.</p>
        <ul class="ml-4 my-4"><li>Via Email:  <a href="mailto:info@akhbarmeter.org">info@akhbarmeter.org</a></li><li>Via this Link:  https://akhbarmeter.org/contact</li>
        </ul>
    </div>
@endsection
