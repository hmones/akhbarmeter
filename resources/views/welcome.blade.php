...
@section('content')
    ...
    <!-- Fake News section -->
    <section class="py-16">
        <x-page-header headline="Fake news!" description="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa libero labore natus atque, ducimus sed."/>
    ...
    <section class="py-16">
        <x-page-header headline="Insights & Partners" description="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsa libero labore natus atque, ducimus sed."/>
        <div class="container">
            <div class="shadow-lg bg-white border-1 border-solid border-gray-200 py-8 px-8 lg:px-24 rounded-4">
                <div class="flex flex-row justify-between mx-auto text-center">
                    <div class="flex flex-col space-y-4">
                        <div class="text-xl leading-7 font-bold lg:text-5xl lg:leading-none lg:font-extrabold text-blue-500">10</div>
                        <div class="text-sm lg:text-lg leading-6 font-medium text-gray-400">Publishers</div>
                    </div>
                    <div class="flex flex-col space-y-4">
                        <div class="text-xl leading-7 font-bold lg:text-5xl lg:leading-none lg:font-extrabold text-blue-500">1000+</div>
                        <div class="text-sm lg:text-lg leading-6 font-medium text-gray-400">Topics</div>
                    </div>
                    <div class="flex flex-col space-y-4">
                        <div class="text-xl leading-7 font-bold lg:text-5xl lg:leading-none lg:font-extrabold text-blue-500">19000+</div>
                        <div class="text-sm lg:text-lg leading-6 font-medium text-gray-400">Review</div>
                    </div>
                    <div class="flex flex-col space-y-4">
                        <div class="text-xl leading-7 font-bold lg:text-5xl lg:leading-none lg:font-extrabold text-blue-500">3</div>
    ...
    <div class="bg-blue-700">
        <div class="container flex flex-col lg:flex-row py-16 lg:space-x-8">
            <div class="flex flex-col py-8 pe-4 space-y-8 border-b-2 lg:border-b-0 lg:border-r-2 border-solid border-blue-900 text-white lg:w-1/2">
