...
return new class extends Migration
{
    ...
    {
        PublisherScore::where('period', 'week')->delete();
        $weeklyScores = DB::table('cairo_mediameter_pscores')->where('score_period', 'week')->orderBy('score_from', 'desc')->orderBy('score_percent', 'desc')->get()->groupBy('score_from');

        $weeklyScores->each(function ($period) {
