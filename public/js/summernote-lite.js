...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        icons: {
            'align': 'align icon',
            'alignCenter': 'align-center icon',
            'alignJustify': 'align-justify icon',
            'alignLeft': 'align-left icon',
            'alignRight': 'align-right icon',
            'rowBelow': 'row-below icon',
            'colBefore': 'col-before icon',
            'colAfter': 'col-after icon',
            'rowAbove': 'row-above icon',
            'rowRemove': 'row-remove icon',
            'colRemove': 'col-remove icon',
            'indent': 'align-indent icon',
            'outdent': 'align-outdent icon',
            'arrowsAlt': 'arrows-alt icon',
            'bold': 'bold icon',
            'caret': 'caret icon',
            'circle': 'circle icon',
            'close': 'close icon',
            ...
            'italic': 'italic icon',
            'link': 'unlink icon',
            'unlink': 'chain-broken icon',
            'magic': 'magic icon',
            'menuCheck': 'menu-check icon',
            'minus': 'minus icon',
            'orderedlist': 'list ol icon',
            'pencil': 'pencil icon',
            ...
            'table': 'table icon',
            'textHeight': 'text-height icon',
            'trash': 'trash icon',
            'underline': 'underline icon',
            'undo': 'undo icon',
            'unorderedlist': 'list ul icon',
            'video': 'video icon'
        }
    }
});
